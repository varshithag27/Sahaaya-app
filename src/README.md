...
1. **Clone the repository**
   ```bash
   git clone https://github.com/varshithag27/sahaaya-app.git
   cd sahaaya-app
   ```
...
Project Link: [https://github.com/yourusername/sahaaya-app](https://github.com/varshithag27/sahaaya-app)
